...
public class IncomeService {
  ...
  private void makeIncome(Income income) {
    accountService.plusSum(income.getAccountId(), income.getSum());
  }

  private void rollbackIncome(Income income) {
    accountService.minusSum(income.getAccountId(), income.getSum());
  }
  ...
  private void oldIncomeToNewIncomeMapping(Income oldIncome, Income newIncome) {
    ...
    if (newIncome.getAccountId() == null) {
      newIncome.setAccountId(oldIncome.getAccountId());
    }
