...
public class ExpenseService {
  ...
  private void makeExpense(Expense expense) {
    accountService.minusSum(expense.getAccountId(), expense.getSum());
  }

  private void rollbackExpense(Expense expense) {
    accountService.plusSum(expense.getAccountId(), expense.getSum());
  }
  ...
  private void oldExpenseToNewExpenseMapping(Expense oldExpense, Expense newExpense) {
    ...
    if (newExpense.getAccountId() == null) {
      newExpense.setAccountId(oldExpense.getAccountId());
    }
