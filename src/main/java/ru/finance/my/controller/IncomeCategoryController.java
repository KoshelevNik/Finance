...
public class IncomeCategoryController {
  ...
  @GetMapping
  public List<IncomeCategory> getAll(@RequestParam("user-id") Long userId) {
    return incomeCategoryService.getAll(userId);
  }
  ...
  public IncomeCategory deleteById(@PathVariable Long incomeCategoryId, @RequestBody IncomeCategory incomeCategory) {
