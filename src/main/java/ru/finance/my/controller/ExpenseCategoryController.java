...
public class ExpenseCategoryController {
  ...
  @GetMapping
  public List<ExpenseCategory> getAll(@RequestParam("user-id") Long userId) {
    return expenseCategoryService.getAll(userId);
  }
  ...
  public ExpenseCategory deleteById(@PathVariable Long expenseCategoryId, @RequestBody ExpenseCategory expenseCategory) {
